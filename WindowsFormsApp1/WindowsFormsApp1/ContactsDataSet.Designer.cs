...
namespace WindowsFormsApp1 {
    ...
    public partial class ContactsDataSet : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow AddPersonRow(int Contact_id, string FirstName, string LastName, string Email, string City, int PhoneNumber) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public PersonRow FindByContact_id(int Contact_id) {
        ...
        public partial class PersonRow : global::System.Data.DataRow {
            ...
            public int Contact_id {
                get {
                    return ((int)(this[this.tablePerson.Contact_idColumn]));
                }
                set {
                    this[this.tablePerson.Contact_idColumn] = value;
                }
            }
            ...
            public int PhoneNumber {
                get {
                    return ((int)(this[this.tablePerson.PhoneNumberColumn]));
                }
                set {
...
namespace WindowsFormsApp1.ContactsDataSetTableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Person] WHERE (([Contact_id] = @Original_Contact_id) AND ([FirstName] = @Original_FirstName) AND ([LastName] = @Original_LastName) AND ([Email] = @Original_Email) AND ([City] = @Original_City) AND ([PhoneNumber] = @Original_PhoneNumber))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Person] ([Contact_id], [FirstName], [LastName], [Email], [City], [PhoneNumber]) VALUES (@Contact_id, @FirstName, @LastName, @Email, @City, @PhoneNumber);
SELECT Contact_id, FirstName, LastName, Email, City, PhoneNumber FROM Person WHERE (Contact_id = @Contact_id)";
...
SELECT Contact_id, FirstName, LastName, Email, City, PhoneNumber FROM Person WHERE (Contact_id = @Contact_id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WindowsFormsApp1.Properties.Settings.Default.ContactsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Contact_id, FirstName, LastName, Email, City, PhoneNumber FROM dbo.Person";
        ...
        public virtual int Fill(ContactsDataSet.PersonDataTable dataTable) {
        ...
        public virtual ContactsDataSet.PersonDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            ContactsDataSet.PersonDataTable dataTable = new ContactsDataSet.PersonDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(ContactsDataSet.PersonDataTable dataTable) {
        ...
        public virtual int Delete(int Original_Contact_id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_City, int Original_PhoneNumber) {
        ...
        public virtual int Insert(int Contact_id, string FirstName, string LastName, string Email, string City, int PhoneNumber) {
        ...
        public virtual int Update(int Contact_id, string FirstName, string LastName, string Email, string City, int PhoneNumber, int Original_Contact_id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_City, int Original_PhoneNumber) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string City, int PhoneNumber, int Original_Contact_id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_City, int Original_PhoneNumber) {
            return this.Update(Original_Contact_id, FirstName, LastName, Email, City, PhoneNumber, Original_Contact_id, Original_FirstName, Original_LastName, Original_Email, Original_City, Original_PhoneNumber);
        }
    }
